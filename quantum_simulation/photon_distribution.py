...
class Photon_distribution:
    ...
    def __init__(self, simulation_params, quantum_params, states, time_interval):
        ...
        self.Delta_Na = dq.expect(dq.tensor(quantum_params.N_a @ quantum_params.N_a, dq.eye(self.DIM_B)), states) - self.Na**2
        self.Delta_Nb = dq.expect(dq.tensor(dq.eye(self.DIM_A), quantum_params.N_b @ quantum_params.N_b), states) - self.Nb**2        
        self.states = states
